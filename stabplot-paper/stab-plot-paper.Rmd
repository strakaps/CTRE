...
where $T(l,i)$ is the inter-arrival time between the $(i-1)$th and the $i$th event which exceed the level $i$. This new CTRM process has the same distribution as the
original CTRM $V(t)$. By repetition, we can construct i.i.d.\ sequences
$\{T(\ell,i)\}_{i}$ and
$\{X(\ell,i)\}_{i}$ for any given threshold $\ell$.
