...
: The pairs $(W_i, J_i)$ are i.i.d. An indication if this is true is given 
  by an auto-correlation plot for the two time series.
...
#Acknowledgements
The first author was supported by DAAD co-financed by the German Federal Ministry of Education and Research (BMBF). We also would like to thank Peter Scheffler, who laid the foundation of this work and Gurtek Gill who helped to create the MittagLeffleR R-package. 
